...
const selectNewContact=(contact)=>{
  ...
  <Tooltip>
    <TooltipTrigger>
        <FaPlus className="text-neutral-400 font-light text-opacity-90 text-start hover:text-neutral-100 cursor-pointer transition-all duration-300" onClick={()=>setOpenNewConatctModal(true)}/>
    </TooltipTrigger>
        ...
        <div className="flex flex-col gap-5">
            {
                searchedConatct.map((contact)=>(
                    <div key={contact._id} className="flex gap-3 ite cursor-pointer" 
